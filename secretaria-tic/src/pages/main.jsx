...
export default function Main(){
    ...
    const titleOferta = "¡Avanzando en lo Digital 2026!";
    const textOferta = "La Secretaría de Tecnologías de la Información y las Comunicaciones reafirma su compromiso con la comunidad bugueña presentando “Avanzando en lo Digital 2026”, una nueva edición de nuestra estrategia para seguir cerrando la brecha digital y fortalecer las competencias tecnológicas en el municipio.";
